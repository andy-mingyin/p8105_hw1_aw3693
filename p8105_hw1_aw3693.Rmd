...
```
The random_sample and logical vector work, since random_sample is numeric and logical vector contains true and false, which are 1 and 0 respectively. The character vectors and factor vectors do not work, since we cannot take the average of characters, and factors are categorical.
